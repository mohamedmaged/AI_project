...
public class panel3 extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "", "blue", "purple", "yellow", "red", "white", "pink", "orange", "violet", "pinkish-red" }));
        add(jComboBox1);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
         Globals.COLOR= (String)jComboBox1.getItemAt(jComboBox1.getSelectedIndex());
